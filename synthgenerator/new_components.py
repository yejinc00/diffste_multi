...
class WordSampler(Component):
    vocab = ['봄', '바', '람', '달', '려', '가', '다', '호', '수', '의', '자', '소', '나', '기', '언', '덕', '골', '목', '길', '미', '초', '콜', '릿', '비', '별', '빛', '개', '아', '침', '햇', '살', '향', '연', '못', '코', '끝', '줄', '녀', '산', '해', '라', '그', '림', '이', '는', '밤', '변', '무', '지', '마', '음', '눈', '물', '벚', '꽃', '하', '늘', '화', '볕', '모', '래', '사', '장', '작', '은', '방', '강', '울', '우', '캠', '프', '파', '어', '카', '페', '노', '을', '커', '피', '불', '놀', '랑', '열', '대', '과', '일', '콤', '함', '저', '녁', '송', '들', '닥', '푸', '른', '닷', '님', '벌', '새', '리', '구', '름', '느', '릅', '빙', '고', '요', '영', '스', '크', '추', '억', '천', '둥', '번', '낙', '엽', '팔', '첫', '북', '극', '안', '선', '원', '오', '시', '간', '태', '양', '질', '녘', '청', '정', '창', '밖', '량', '한', '란', '날', '밀', '밭', '벽', '쁨', '록', '속', '도']
